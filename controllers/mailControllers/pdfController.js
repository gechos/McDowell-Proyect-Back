...
const getpdfOrder = async (req, res) => {
  ...
  //cargamos fs para poder tratar una plantilla html y generador pdf html-pdf
  ...
  // Remplazar el valor {{tablaProductos}} por el verdadero valor en HTML
  ...
  // creamos pdf y enviamos mail si ok
